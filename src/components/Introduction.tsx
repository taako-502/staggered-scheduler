...
const Introduction = () => (
  <section className="px-8 py-12">
    <div>
      ...
      Are you part of a team spread across different time zones? Or do you often
      find yourself scheduling tasks and meetings across continents? Our app is
      here to simplify your life. Key
      ...
      <ul className="list-disc pl-[18px]">
        ...
        <li>
          <b>User-Friendly Interface:</b> Our intuitive design makes scheduling
          and managing your tasks a breeze.
        </li>
      </ul>
      ...
      <ol className="list-decimal pl-[18px]">
        ...
        <li>
          <b>Add Tasks:</b> Easily add tasks and set deadlines in your preferred
          time zone.
        </li>
        <li>
      ...
      <p>
        ...
        their scheduling process with Global Time Scheduler. Say goodbye to the
        complexities of time zone differences and hello to effortless
        scheduling.
      </p>
